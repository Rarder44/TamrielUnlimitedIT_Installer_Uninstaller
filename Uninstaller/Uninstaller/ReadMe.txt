================================================================================
    LIBRERIA MFC: cenni preliminari sul progetto Unistaller
===============================================================================

La Creazione guidata applicazione ha creato questa applicazione Unistaller. Tale applicazione illustra le nozioni fondamentali sull'utilizzo delle classi MFC (Microsoft Foundation Class) e costituisce un punto di partenza per la scrittura dell'applicazione.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione Unistaller.
...
Unistaller.h
    ...
    Include altre intestazioni specifiche del progetto, ad esempio resource.h, e dichiara la classe di applicazione CUnistallerApp.

Unistaller.cpp
    File di origine principale dell'applicazione contenente la classe di applicazione CUnistallerApp.
...
res\Unistaller.ico
    File di icona utilizzato come icona dell'applicazione. Tale icona è inclusa dal file di risorse principale Unistaller.rc.
...
UnistallerDlg.h, UnistallerDlg.cpp - la finestra di dialogo
    Questi file contengono la classe CUnistallerDlg. Questa classe definisce il comportamento della finestra di dialogo principale dell'applicazione. Il modello della finestra di dialogo è in Unistaller.rc che può essere modificato in Microsoft Visual C++.
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato Unistaller.pch e il file dei tipi precompilato StdAfx.obj.
